...
namespace sict {
	...
	Fraction Fraction::operator* (const Fraction& rhs) const {
		...
		if (!isEmpty() && !rhs.isEmpty()) {
			a.m_numerator = (m_numerator * rhs.m_numerator);
			a.m_denominator = (m_denominator * rhs.m_denominator);
			a.reduce();
		}
	...
	Fraction Fraction::operator+= (const Fraction& rhs) {
		...
		if (!isEmpty() && !rhs.isEmpty()) {
			this->m_numerator = (m_numerator * rhs.m_denominator) + (rhs.m_numerator * m_denominator);
			this->m_denominator = m_denominator * rhs.m_denominator;
			this->reduce();
		}
